...
const STORE = [
    {
      ...
      blurb: '1145 Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length....San Diego is the second-most populous city in California, behind L.A. (4.1 million). The population of San Diego <em>county</em> is about 3.3 million',
      image: 'population.jpg',
      alt: 'people on a San Diego beach'
    },
    {
      question: 'What is the nickname of San Diego\'s International Airport?',
      answers: [
        'Lindbergh Field',
        'SoCal International',
        'Jack Murphy Field',
    ...
    {
      question: 'What is the name of San Diego\'s MLB team?',
      answers: [
        'The Padres',
        'The Chargers',
        'The Rams',
        ...
        correctAnswer: 'The Padres',
        image: 'padres.jpg',
        blurb: 'In tribute to the Catholic monks who founded the city, San Diego\'s baseball team was named the Padres.',
    ...
    {
      question: 'Around how many golf courses are there in San Diego?',
      answers: [
        '50',
        '25',
        '100',
      ...
      correctAnswer: '100',
      image: 'golf.jpg',
      blurb: 'With nearly 100 golf courses in the area, it\'s fair to say that golf is the city\'s most popular sport.',
    ...
    {
      question: 'Which destination is the most-visited National Monument in California?',
      answers: [
      'Cabrillo',
    ...
    {
      question: 'The world-famous San Diego Zoo has how many animals?',
      answers: [
        'about 200',
        'about 1,000',
        'about 2,000',
    ...
    {
      question: 'What is NOT located in Balboa Park?',
      answers: [
      'San Diego Zoo',
      'Botanical Building',
      'Museum of Man',
    ...
    {
      question: 'Which annual event held in the San Diego Convention Center takes over the entire city for the week leading up to and after it?',
      answers: [
        'Comic-Con',
        'DEF CON',
