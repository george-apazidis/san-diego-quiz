...
const STORE = [
    {
      ...
      blurb: 'Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length.... Extra text to test length....San Diego is the second-most populous city in California, behind L.A. (4.1 million). The population of San Diego <em>county</em> is about 3.3 million',
